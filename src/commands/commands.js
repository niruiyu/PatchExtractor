  ...
  mailItem.body.getAsync(
    ...
    function(result) {
      ...
      if (success) {
        ...
        prompt(Office.MailboxEnums.ItemNotificationMessageType.InformationalMessage, "Extracting patch... Done. But the file may not be in patch format!");
      }
